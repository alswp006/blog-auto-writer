...
위 텍스트에서 이 장소의 구체적인 메뉴 항목 이름과 가격을 추출해주세요.

규칙:
- 2~5개 추출
- "브런치", "음료", "디저트" 같은 카테고리가 아닌 실제 메뉴명을 추출 (예: "에그베네딕트", "아메리카노", "티라미수")
- 블로그에서 직접 언급된 메뉴명이 있으면 그대로 사용
- 직접적인 메뉴명이 없더라도, 장소 유형과 맥락에서 추론 가능한 대표 메뉴를 포함해도 좋음
- 대표/시그니처/인기 메뉴 우선
- 가격은 원 단위 정수 (예: 12000), 모르면 0
- 여러 블로그에 공통으로 언급된 메뉴 우선

JSON으로 응답: { "menus": [{ "name": "에그베네딕트", "price": 15000 }, { "name": "아메리카노", "price": 5000 }] }`;
